...
Pterodactyl:
Ubuntu: ssh -i ${path.module}/ec2-private-key.pem ubuntu@${module.ec2_pterodactyl.public_ip}
Amazon Linux: ssh -i ${path.module}/ec2-private-key.pem ec2-user@${module.ec2_pterodactyl.public_ip}
